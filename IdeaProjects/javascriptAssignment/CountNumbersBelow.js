function countNumbersBelowThreshold(numbersList, thresholdValue)
{
    var count = 0;
...
function input()
{
    ...
    console.log("The count of the numbers below threshold value is: ")
    console.log(countNumbersBelowThreshold(numbersList,value))
}
